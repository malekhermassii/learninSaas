...
const UserSchema = new mongoose.Schema({
    ...
    email: {type: String,required: true, unique: true, lowercase: true } ,// L'email sera converti en minuscules
    password: {type: String,required: true,}, // Le mot de passe est requis
    createdAt: {type: Date,default: Date.now,} ,// La date de création de l'utilisateur
